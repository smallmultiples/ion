...
(function() {
  var Node, Token, args, arr_delim, content, fs, getArray, ion, isText, min, nest, obj_delim, object, parseTokens, processUnquoted, quote, sep, str, tokentypes, wordwrap, wordwrap_len;
  ...
  Node = (function() {
    ...
    Node.prototype.getSmallestDescendantIndent = function() {
      var child, smallest, _i, _len, _ref;
      smallest = null;
    ...
    Node.prototype.getAllDescendantLines = function(lines, indent) {
      ...
      if (indent == null) {
        indent = this.getSmallestDescendantIndent();
      }
      if (this.children != null) {
        _ref = this.children;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  getArray = function(tokens) {
    ...
    return (function() {
      ...
      _results = [];
      for (_j = 0, _len1 = tokens.length; _j < _len1; _j += 2) {
        item = tokens[_j];
  ...
  nest = function(nodes) {
    var node, parent, root, stack, _i, _len;
    ...
    for (_i = 0, _len = nodes.length; _i < _len; _i++) {
      ...
      (parent.children != null ? parent.children : parent.children = []).push(node);
      stack.push(node);
    }
    return root;
  };
  ...
  wordwrap = function(str, width, brk, cut) {
    ...
    return str.match(RegExp(regex, "g")).map(function(s) {
      return s.replace(/\n$/, '');
    }).join(brk);
  };

  str = function(key, holder, first_run, gap, indent, replacer) {
    var e, i, k, length, mind, partial, replaced, v, value;
    if (first_run == null) {
      first_run = false;
    }
    if (gap == null) {
    ...
    switch (typeof value) {
      ...
      case "object":
        ...
        if (Object.prototype.toString.apply(value) === "[object Array]") {
          ...
          i = 0;
          while (i < length) {
            partial[i] = str(i, value, true, '', indent, replacer) || "null";
            i += 1;
          }
          v = (partial.length === 0 ? "[]" : arr_delim[0] + "\n" + partial.join(sep + "\n").replace(/^\n/, '').replace(/^/gm, gap) + mind + arr_delim[1]);
          gap = mind;
          return v;
        }
  ...
  ion = {
    ...
    stringify: function(value, replacer, space) {
      ...
      if (replacer && typeof replacer !== "function" && (typeof replacer !== "object" || typeof replacer.length !== "number")) {
        throw new Error("ION.stringify replacer");
      }
      return str("", {
        "": value
      }, true, '', indent, replacer);
    }
  };
